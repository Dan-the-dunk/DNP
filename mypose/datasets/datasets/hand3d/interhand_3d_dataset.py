...
from mypose.codecs.utils import camera_to_pixel
from mypose.datasets.datasets import BaseCocoStyleDataset
from mypose.registry import DATASETS
from mypose.structures.bbox import bbox_xywh2xyxy
