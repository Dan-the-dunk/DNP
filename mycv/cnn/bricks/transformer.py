...
from mycv.cnn import (Linear, build_activation_layer, build_conv_layer,
                      build_norm_layer)
...
try:
    from mycv.ops.multi_scale_deform_attn import \
        MultiScaleDeformableAttention  # noqa F401
    warnings.warn(
        ImportWarning(
            '``MultiScaleDeformableAttention`` has been moved to '
            '``mmcv.ops.multi_scale_deform_attn``, please change original path '  # noqa E501
            '``from mycv.cnn.bricks.transformer import MultiScaleDeformableAttention`` '  # noqa E501
